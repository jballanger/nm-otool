...
/*   Updated: 2018/06/15 15:13:20 by julien           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	get_symbol_type(struct nlist_64 nlist, t_sect *sect)
{
	t_sect	*s;
	char	type;
...
void	store_symbol(t_file **file, struct nlist_64 nlist, char *s_table)
{
	t_file		*f;
	t_symbol	*symbol;
